...
package ru.mtuci.musicanalyzer.apollo;
...
import ru.mtuci.musicanalyzer.apollo.appwidgets.AppWidgetLarge;
import ru.mtuci.musicanalyzer.apollo.appwidgets.AppWidgetLargeAlternate;
import ru.mtuci.musicanalyzer.apollo.appwidgets.AppWidgetSmall;
import ru.mtuci.musicanalyzer.apollo.appwidgets.RecentWidgetProvider;
import ru.mtuci.musicanalyzer.apollo.cache.ImageCache;
import ru.mtuci.musicanalyzer.apollo.cache.ImageFetcher;
import ru.mtuci.musicanalyzer.apollo.provider.FavoritesStore;
import ru.mtuci.musicanalyzer.apollo.provider.RecentStore;
import ru.mtuci.musicanalyzer.apollo.utils.ApolloUtils;
import ru.mtuci.musicanalyzer.apollo.utils.Lists;
import ru.mtuci.musicanalyzer.apollo.utils.MusicUtils;
import ru.mtuci.musicanalyzer.apollo.utils.PreferenceUtils;
...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "ru.mtuci.musicanalyzer.apollo.playstatechanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "ru.mtuci.musicanalyzer.apollo.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "ru.mtuci.musicanalyzer.apollo.queuechanged";

    /**
     * Indicates the repeat mode chaned
     */
    public static final String REPEATMODE_CHANGED = "ru.mtuci.musicanalyzer.apollo.repeatmodechanged";

    /**
     * Indicates the shuffle mode chaned
     */
    public static final String SHUFFLEMODE_CHANGED = "ru.mtuci.musicanalyzer.apollo.shufflemodechanged";

    /**
     * For backwards compatibility reasons, also provide sticky
     * broadcasts under the music package
     */
    public static final String APOLLO_PACKAGE_NAME = "ru.mtuci.musicanalyzer.apollo";
     ...
     */
    public static final String SERVICECMD = "ru.mtuci.musicanalyzer.apollo.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "ru.mtuci.musicanalyzer.apollo.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "ru.mtuci.musicanalyzer.apollo.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "ru.mtuci.musicanalyzer.apollo.stop";

    /**
     * Called to go to the previous track
     */
    public static final String PREVIOUS_ACTION = "ru.mtuci.musicanalyzer.apollo.previous";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "ru.mtuci.musicanalyzer.apollo.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "ru.mtuci.musicanalyzer.apollo.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "ru.mtuci.musicanalyzer.apollo.shuffle";

    /**
     * Called to update the service about the foreground state of Apollo's activities
     */
    public static final String FOREGROUND_STATE_CHANGED = "ru.mtuci.musicanalyzer.apollo.fgstatechanged";
     ...
     * changes
     */
    public static final String REFRESH = "ru.mtuci.musicanalyzer.apollo.refresh";

    /**
     * Called to build the notification while Apollo is in the background
     */
    public static final String START_BACKGROUND = "ru.mtuci.musicanalyzer.apollo.startbackground";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "ru.mtuci.musicanalyzer.apollo.updatelockscreen";
