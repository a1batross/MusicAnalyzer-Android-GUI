...
import ru.mtuci.musicanalyzer.apollo.widgets.ColorPickerView.OnColorChangedListener;
...
public class ColorSchemeDialog extends AlertDialog implements
    ...
    /*
     * (non-Javadoc)
     * @see ru.mtuci.musicanalyzer.apollo.widgets.ColorPickerView.OnColorChangedListener#
     * onColorChanged(int)
     */
    @Override
